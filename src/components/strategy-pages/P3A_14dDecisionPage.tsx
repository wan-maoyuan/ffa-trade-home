  ...
  return (
    <div className="strategy-page">
      <div className="strategy-container">
        <p className="strategy-page-title">P3A现货应用决策（14天后）</p>
        ...
        {loading ? (
          ...
          <>
            ...
            <div className="strategy-chips">
              <div className="strategy-chip">做空胜率统计</div>
            ...
            {analysis.p3a_current_evaluation && (
              <div className="strategy-content-card" style={{ marginTop: '20px' }}>
                <p className="strategy-page-title" style={{ fontSize: '18px', textAlign: 'left', marginBottom: '16px' }}>P3A当前评估价格</p>
                <div className="strategy-metrics-grid" style={{ gridTemplateColumns: 'repeat(auto-fit, minmax(160px, 1fr))' }}>
                  <div className="strategy-metric-item">
                    <p className="strategy-metric-label">日期</p>
                    <p className="strategy-metric-value">{analysis.p3a_current_evaluation.date}</p>
                  </div>
                  <div className="strategy-metric-item">
                    <p className="strategy-metric-label">当前价格/元每吨</p>
                    <p className="strategy-metric-value">{analysis.p3a_current_evaluation.current_price.toLocaleString()}</p>
                  </div>
                  <div className="strategy-metric-item">
                    <p className="strategy-metric-label">评估价格/元每吨</p>
                    <p className="strategy-metric-value">{analysis.p3a_current_evaluation.evaluated_price.toLocaleString()}</p>
                  </div>
                  <div className="strategy-metric-item">
                    <p className="strategy-metric-label">价差比</p>
                    <p className="strategy-metric-value">{analysis.p3a_current_evaluation.price_difference_ratio}</p>
                  </div>
                </div>
              </div>
            )}
