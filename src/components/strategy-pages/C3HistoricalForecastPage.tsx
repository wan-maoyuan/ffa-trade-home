...
const C3HistoricalForecastPage: React.FC = () => {
    ...
    useEffect(() => {
        const fetchData = async () => {
            try {
                setLoading(true)
                const response = await fetch('https://aqua.navgreen.cn/api/backtest/backtest_C3_historical_forecast_data')
    ...
    return (
        <div className="strategy-page p5-historical-page">
            <div className="strategy-page-content-wrapper" style={{ width: '100%' }}>
                <p className="strategy-page-title">C3历史预测回测分析</p>
...
export default C3HistoricalForecastPage
