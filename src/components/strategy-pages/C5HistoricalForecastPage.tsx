...
const C5HistoricalForecastPage: React.FC = () => {
    ...
    useEffect(() => {
        const fetchData = async () => {
            try {
                setLoading(true)
                const response = await fetch('https://aqua.navgreen.cn/api/backtest/backtest_C5_historical_forecast_data')
...
export default C5HistoricalForecastPage
